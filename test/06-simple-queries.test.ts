...
describe("Simple Queries", () => {
  ...
  it(
    ...
    async (done) => {
      // izvada summas, puslidz ir pareizas, bet drusku pietrukst, un nav aiz komata cipari
      const query = `SELECT 
  ...
  //AND FORMAT (release_date, 'yyyy' > '2009'
  it(
  ...
  it(
    ...
    async (done) => {
      const query = `SELECT COUNT(*) as count, release_date as year
      FROM ${MOVIES}
